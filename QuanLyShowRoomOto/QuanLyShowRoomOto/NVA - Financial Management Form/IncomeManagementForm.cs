...
namespace QuanLyShowRoomOto
{
	public partial class IncomeManagementForm : Form
	{
		...
		{
			string sqlString = "select * from vw_Tien_Thu";
			fillChart(sqlString);
			int unpaid;
			int paid;
			if (tb.Rows.Count == 0)
			...
			chartIncome.Series[0].XValueMember = "TrangThai";
			chartIncome.Series[0].YValueMembers = "Tien";
			chartIncome.Titles.Add("Biểu đồ quản lý thu");
